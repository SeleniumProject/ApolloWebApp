...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <p>FirstName:&nbsp;<span style="color: #FF0000">*</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:TextBox ID="TextBox7" MaxLength="50" placeholder="Enter the FirstName" runat="server" Width="286px"></asp:TextBox>
    ...
    <p>LastName:&nbsp;<span style="color: #FF0000">*</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:TextBox ID="TextBox2" MaxLength="50" placeholder="Enter the LastName" runat="server" Width="286px"></asp:TextBox>
    ...
    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Email Address:&nbsp;<span style="color: #FF0000">*</span>&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:TextBox ID="TextBox3" runat="server" placeholder="Enter the Email Address" Width="286px"></asp:TextBox>
    ...
    <p>Password:&nbsp;<span style="color: #FF0000">*</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:TextBox ID="TextBox5" MaxLength="12" placeholder="Enter the Password" runat="server" TextMode="Password" Width="286px"></asp:TextBox>
...
&nbsp;</p>
    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Confirm Password:<span style="color: #FF0000">*</span> <asp:TextBox ID="TextBox6" MaxLength="12" placeholder="Enter the Confirm Password" runat="server" TextMode="Password" Width="286px"></asp:TextBox>
